        ...
        if substring != []:
            for k in range(len(substring)):
                if biggest_number is None:
                    biggest_number = substring[k]
                else:
                    if substring[k] > biggest_number:
                        biggest_number = substring[k]
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = None
    answer = largest_negative_number([(1, 2, 4),
                             (13, 10, 11, 7, 10),
                             [1, 2, 3, 4]])
    print('Expected and actual are:', expected, answer)
    ...
    # Test 3:
    expected = -1.2
    answer = largest_negative_number(([-3, 5, -10], [-1.2, 1, 6], [-7, -4, -9]))
    print('Expected and actual are:', expected, answer)
    ...
    # Test 4:
    expected = -11
    answer = largest_negative_number([(-20, -19, -18),
                             (-17, -16, -15, -14, -13),
                             [-12, -11]])
    print('Expected and actual are:', expected, answer)
...
def largest_negative_number(seq_seq):
    ...
    # largest_neg_number = 0

    # for j in range(len(seq_seq)):

    largest_neg_number = None

    for j in range(len(seq_seq)):
        substring = seq_seq[j]

        for k in range(len(substring)):
            if largest_neg_number is None:
                if substring[k] < 0:
                    largest_neg_number = substring[k]
            else:
                if substring[k] < 0:
                    if substring[k] > largest_neg_number:
                        largest_neg_number = substring[k]
